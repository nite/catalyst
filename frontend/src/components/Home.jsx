  ...
  const features = [
    {
      ...
      description:
        "Access 15+ curated datasets from data.gov, World Bank, Our World in Data, NOAA, and US Census",
    },
    {
      icon: <FiBarChart2 className="h-8 w-8" />,
      title: "Smart Visualizations",
      description:
        "Automatically configured charts based on data types - line charts, bar charts, pie charts, and more",
    },
    {
      icon: <FiFilter className="h-8 w-8" />,
      title: "Interactive Filters",
      description:
        "Filter data by date ranges, categories, and numeric values with intuitive controls",
    },
    {
      icon: <FiSmartphone className="h-8 w-8" />,
      title: "Mobile-First Design",
      description:
        "Responsive interface that works seamlessly on phones, tablets, and desktops",
    },
  ];
    ...
    <div className="space-y-6 h-full overflow-y-auto">
      ...
      <section className="rounded-[28px] bg-white/85 border border-white/70 shadow-[0_30px_80px_-60px_rgba(15,118,110,0.7)] px-6 py-10 md:px-12 md:py-14 animate-rise">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
          <div className="space-y-6">
            <p className="uppercase tracking-[0.25em] text-xs text-primary-600 font-semibold">
              Insight Studio
            </p>
            ...
            <p className="text-lg text-gray-600 max-w-xl">
              Catalyst is a mobile-first analytics studio for open data. Build
              stories from curated datasets, swipe through insights, and share
              confident answers.
            </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          >
            ...
            <p className="text-lg font-semibold text-gray-900 font-display mt-2">
              {step.description}
            </p>
          </div>
        ))}
      ...
      <section className="bg-white/90 rounded-[24px] shadow-[0_30px_80px_-60px_rgba(15,118,110,0.5)] p-8 border border-white/70">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {["Health", "Economy", "Climate", "Demographics", "Education"].map(
            (category) => (
              <Link
                key={category}
      ...
      <section className="text-center space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={source}
              className="p-4 bg-white/90 rounded-xl shadow-sm border border-white/60"
            >
